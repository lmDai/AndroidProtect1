package com.pictureselect.photopicker.adapter;
...
import com.pictureselect.photopicker.utils.UriUtils;
...
public class PhotoPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (path.startsWith("http")) {
            ...
            uri = UriUtils.file2Uri(container.getContext(), new File(path));
        }
        Glide.with(mContext)
                .load(uri)
                .placeholder(R.drawable.loading)
                .override(800, 800)
                .fallback(R.drawable.ic_broken_image_black_48dp)
