package com.cqyanyu.backing.ui.widget.input;
...
public class SmoothInputLayout extends LinearLayout {
    private static final int DEFAULT_KEYBOARD_HEIGHT = 387;
    private static final int MIN_KEYBOARD_HEIGHT = 20;
    private static final String SP_KEYBOARD = "keyboard";
    private static final String KEY_HEIGHT = "height";
    //属性值
    private String defaultKeyHeight = "silDefaultKeyboardHeight";
    private String keyHeight = "silMinKeyboardHeight";
    private String inputView = "silInputView";
    private String inputPane = "silInputPane";
    private String savekeyHeight = "silAutoSaveKeyboardHeight";
    ...
    private void initView(AttributeSet attrs) {
        defaultInputHeight = (int) (DEFAULT_KEYBOARD_HEIGHT * getResources().getDisplayMetrics().density);
        minInputHeight = (int) (MIN_KEYBOARD_HEIGHT * getResources().getDisplayMetrics().density);
        mInputViewId = NO_ID;
        mInputPaneId = NO_ID;
    ...
    private void initAttributeSet(AttributeSet attrs) {
        if (attrs != null) {
            autoSave = attrs.getAttributeBooleanValue(null, savekeyHeight, true);
            defaultInputHeight = attrs.getAttributeIntValue(null, defaultKeyHeight, defaultInputHeight);
            minInputHeight = attrs.getAttributeIntValue(null, keyHeight, minInputHeight);
            mInputViewId = attrs.getAttributeResourceValue(null, inputView, mInputViewId);
            mInputPaneId = attrs.getAttributeResourceValue(null, inputPane, mInputPaneId);
        }
        ...
        <attr name="silInputPane" format="reference"/>
     ...
     * @param height 输入面板高度
     */
    private void setDefaultKeyboardHeight(int height) {
     ...
     * @param height 输入面板高度
     */
    private void setMinKeyboardHeight(int height) {
     ...
     * @param edit 输入框
     */
    private void setInputView(View edit) {
        if (mInputView != edit)
            mInputView = edit;
    }
     ...
     * @param pane 面板
     */
    private void setInputPane(View pane) {
        if (mInputPane != pane)
            mInputPane = pane;
    }
     ...
     * @param auto 是否自动
     */
    private void setAutoSaveKeyboardHeight(boolean auto) {
     ...
     * @return 特殊输入面板已打开
     */
    private boolean isInputPaneOpen() {
