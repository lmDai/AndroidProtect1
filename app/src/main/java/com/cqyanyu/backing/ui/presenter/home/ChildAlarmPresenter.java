...
import com.cqyanyu.backing.ui.holder.home.ChildAlarmHolder;
 ...
 */
public class ChildAlarmPresenter extends XPagePresenter<ChildAlarmView> {
    ...
    public void initPresenter() {
        if (getView() != null) {
            ...
            setRecyclerView();
            /**为mRecyclerView绑定数据*/
            mRecyclerView.getAdapter().bindHolder(new ChildAlarmHolder());
        }
    }
    ...
    protected ParamsMap getParamsMap() {
        ...
        paramsMap.put("deviceid", getView().getLabel());
    ...
    protected String getURL() {
        return ConstHost.GET_CHILD_ALARM_CLASSIFY;
    }

    @Override
    protected Class getClazz() {
        return ChildAlarmEntity.class;
    }
