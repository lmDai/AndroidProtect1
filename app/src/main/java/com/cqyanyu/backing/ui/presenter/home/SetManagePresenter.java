...
import com.cqyanyu.backing.ui.holder.home.InspectionSetHolder;
 ...
 */
public class SetManagePresenter extends XPagePresenter<SetManageView> {
    ...
    public void initPresenter() {
        if (getView() != null) {
            ...
            setRecyclerView();
            /**为mRecyclerView绑定数据*/
            mRecyclerView.getAdapter().bindHolder(new InspectionSetHolder());
        }
    }
    ...
    protected ParamsMap getParamsMap() {
        ...
        paramsMap.put("mtypeid", getView().getLabel());
    ...
    protected String getURL() {
        return ConstHost.GET_PARENT_DEVICE;
    }

    @Override
    protected Class getClazz() {
        return SetInspectionEntity.class;
    }
