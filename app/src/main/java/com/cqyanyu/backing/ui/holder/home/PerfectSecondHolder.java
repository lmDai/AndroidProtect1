 ...
 */
public class PerfectSecondHolder extends IViewHolder {
    ...
    public int getLayout() {
        return R.layout.item_perfect_second;
    }

    private class ViewHolder extends XViewHolder<PerfectSecondEntity> {
        TextView tvCode;
        TextView tvDate;
        ...
        @Override
        protected void onBindData(PerfectSecondEntity itemData) {
            tvSetName.setText(itemData.getTypestr());
            /** 设置设备名称*/
            ...
            if (!TextUtils.isEmpty(itemData.getPosition())&& CommonInfo.getInstance().getUserInfo().isnode()) {
                ...
                tvSetPosition.setText(itemData.getUnitstr() + "@" + itemData.getBuildstr());
            }
            /** 设置item数*/
