 ...
 */
public class CountFireActivity extends BaseActivity<CountAlarmListPresenter> implements CountAlarmView {
    ...
    protected int getLayout() {
        return R.layout.activity_count_fire;
    }
    ...
    protected void initData() {
        setTopTitle(getIntent().getStringExtra("label"));
