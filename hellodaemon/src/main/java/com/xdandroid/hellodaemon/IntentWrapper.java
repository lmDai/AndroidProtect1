            ...
            switch (iw.type) {
                case DOZE:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        builder.setTitle("需要忽略 " + getApplicationName() + " 的电池优化");
                        builder.setMessage(reason + "需要 " + getApplicationName() + " 加入到电池优化的忽略名单。\n\n" +
                ...
                case HUAWEI:
                    ...
                    builder.setTitle("需要允许 " + getApplicationName() + " 自动启动");
                    builder.setMessage(reason + "需要允许 " + getApplicationName() + " 的自动启动。\n\n" +
                ...
                case HUAWEI_GOD:
                    ...
                    builder.setTitle(getApplicationName() + " 需要加入锁屏清理白名单");
                    builder.setMessage(reason + "需要 " + getApplicationName() + " 加入到锁屏清理白名单。\n\n" +
